...
contract Testx is Test {
    ...
    function setUp() external {
        ...
        lending = new UpsideLending(IPriceOracle(address(upsideOracle)), address(usdc));
    ...
    function testDepositEtherWithoutTxValueFails() external {
        (bool success,) = address(lending).call{value: 0 ether}(
            abi.encodeWithSelector(UpsideLending.deposit.selector, address(0x0), 1 ether)
        );
        assertFalse(success);
    }
    ...
    function testDepositEtherWithInsufficientValueFails() external {
        (bool success,) = address(lending).call{value: 2 ether}(
            abi.encodeWithSelector(UpsideLending.deposit.selector, address(0x0), 3 ether)
        );
        assertFalse(success);
    }
    ...
    function testDepositEtherWithEqualValueSucceeds() external {
        (bool success,) = address(lending).call{value: 2 ether}(
            abi.encodeWithSelector(UpsideLending.deposit.selector, address(0x0), 2 ether)
        );
        assertTrue(success);
    ...
    function testDepositUSDCWithInsufficientValueFails() external {
        ...
        (bool success,) = address(lending).call(
            abi.encodeWithSelector(UpsideLending.deposit.selector, address(usdc), 3000 ether)
        );
        assertFalse(success);
    }
    ...
    function testDepositUSDCWithEqualValueSucceeds() external {
        (bool success,) = address(lending).call(
            abi.encodeWithSelector(UpsideLending.deposit.selector, address(usdc), 2000 ether)
        );
        assertTrue(success);
    ...
    function testBorrowWithInsufficientCollateralFails() external {
        supplyUSDCDepositUser1(); // usdc 100000000 ether 를 deposit
        supplySmallEtherDepositUser2(); // ether 1 ether deposit
 
        upsideOracle.setPrice(address(0x0), 1339 ether); // ether 가격 0

        vm.startPrank(user2);
        {
            (bool success,) = address(lending).call(
                abi.encodeWithSelector(UpsideLending.borrow.selector, address(usdc), 1000 ether)
            );
            assertFalse(success);
    ...
    function testBorrowWithSufficientCollateralAfterRepaymentSucceeds() external {
        ...
        vm.startPrank(user2);
        {
            ...
            (success,) = address(lending).call(
                abi.encodeWithSelector(UpsideLending.repay.selector, address(usdc), 1000 ether)
            );
            assertTrue(success);
    ...
    function testBorrowWithInSufficientCollateralAfterRepaymentFails() external {
        ...
        vm.startPrank(user2);
        {
            ...
            (success,) = address(lending).call(
                abi.encodeWithSelector(UpsideLending.borrow.selector, address(usdc), 999 ether)
            );
            assertTrue(success);
        }
        vm.stopPrank();
    ...
    function testWithdrawInsufficientBalanceFails() external {
        ...
        vm.startPrank(user2);
        {
            ...
            (bool success,) = address(lending).call(
                abi.encodeWithSelector(UpsideLending.withdraw.selector, address(0x0), 100000001 ether)
            );
            assertFalse(success);
        }
        vm.stopPrank();
    ...
    function testWithdrawUnlockedBalanceSucceeds() external {
        ...
        vm.startPrank(user2);
        {
            ...
            (bool success,) = address(lending).call(
                abi.encodeWithSelector(UpsideLending.withdraw.selector, address(0x0), 100000001 ether - 1 ether)
            );
            assertTrue(success);
        }
        vm.stopPrank();
    ...
    function testWithdrawMultipleUnlockedBalanceSucceeds() external {
        ...
        vm.startPrank(user2);
        {
            ...
            (bool success,) = address(lending).call(
                abi.encodeWithSelector(UpsideLending.withdraw.selector, address(0x0), 100000000 ether / 4)
            );
            assertTrue(success);
            (success,) = address(lending).call(
                abi.encodeWithSelector(UpsideLending.withdraw.selector, address(0x0), 100000000 ether / 4)
    ...
    function testWithdrawLockedCollateralFails() external {
        ...
        vm.startPrank(user2);
        {
            ...
            (success,) = address(lending).call(
                abi.encodeWithSelector(UpsideLending.withdraw.selector, address(0x0), 1 ether)
            );
            assertFalse(success);
        }
        vm.stopPrank();
    ...
    function testWithdrawLockedCollateralAfterBorrowSucceeds() external {
        ...
        vm.startPrank(user2);
        {
            ...
            // LT = 75%
            (success,) = address(lending).call(
                abi.encodeWithSelector(UpsideLending.withdraw.selector, address(0x0), 1 ether * 1333 / 4000)
            );
            assertTrue(success);
        }
        vm.stopPrank();
    ...
    function testWithdrawYieldSucceeds() external {
        ...
        vm.prank(user3);
        (success,) = address(lending).call(
            abi.encodeWithSelector(UpsideLending.withdraw.selector, address(usdc), 30001605 ether)
        );
        assertTrue(success);
    ...
    function testLiquidationHealthyLoanFails() external {
        ...
        vm.startPrank(user2);
        {
            // use all collateral
            (bool success,) = address(lending).call(
                abi.encodeWithSelector(UpsideLending.borrow.selector, address(usdc), 2000 ether)
            );
            assertTrue(success);
        ...
        vm.startPrank(user3);
        {
            usdc.approve(address(lending), type(uint256).max);
            (bool success,) = address(lending).call(
                abi.encodeWithSelector(UpsideLending.liquidate.selector, user2, address(usdc), 800 ether)
            );
            assertFalse(success);
        }
        vm.stopPrank();
    ...
    function testLiquidationUnhealthyLoanSucceeds() external {
        ...
        vm.startPrank(user3);
        {
            usdc.approve(address(lending), type(uint256).max);
            (bool success,) = address(lending).call(
                abi.encodeWithSelector(UpsideLending.liquidate.selector, user2, address(usdc), 500 ether)
            );
            assertTrue(success);
        }
        vm.stopPrank();
    ...
    function testLiquidationExceedingDebtFails() external {
        ...
        vm.startPrank(user3);
        {
            usdc.approve(address(lending), type(uint256).max);
            (bool success,) = address(lending).call(
                abi.encodeWithSelector(UpsideLending.liquidate.selector, user2, address(usdc), 501 ether)
            );
            assertFalse(success);
        }
        vm.stopPrank();
    ...
    function testLiquidationHealthyLoanAfterPriorLiquidationFails() external {
        ...
        vm.startPrank(user3);
        {
            ...
            assertTrue(success);
            (success,) = address(lending).call(
                abi.encodeWithSelector(UpsideLending.liquidate.selector, user2, address(usdc), 100 ether)
            );
            assertFalse(success);
        }
        vm.stopPrank();
